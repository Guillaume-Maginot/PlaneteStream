  ...
  const input = [
    {
      ...
      content: [
        ...
        'Cherche à classer les œuvres de façon cohérente les unes par rapport aux autres, afin que deux films comparables obtiennent un profil similaire.',
        'Réponds uniquement avec les valeurs autorisées par le schéma.',
        'pace = rythme ressenti par le spectateur.',
        'Choisis :',
        '- lent : contemplatif, mise en place importante, peu d’action, prend son temps.',
        '- moyen : alternance équilibrée entre moments calmes et scènes rythmées.',
        '- rapide : action fréquente, rythme soutenu, peu de temps morts.',
        'complexity = niveau d’attention demandé.',
        '- faible : très facile à suivre.',
        '- moyen : demande un minimum d’attention.',
        '- eleve : intrigue dense, nombreux enjeux ou narration complexe.',
        'humour = place réelle de l’humour.',
        '- faible : quasiment absent.',
        '- moyen : quelques touches régulières.',
        '- eleve : humour très présent.',
        'violence = violence, peur ou tension ressentie.',
        '- faible : peu de violence ou tension.',
        '- moyen : plusieurs scènes marquantes.',
        '- eleve : violence, horreur ou tension omniprésentes.',
        'spectacle = ampleur visuelle et sensation de grand spectacle.',
        '- faible : intimiste.',
        '- moyen : plusieurs scènes impressionnantes.',
        '- eleve : blockbuster, aventure ou spectacle permanent.',
        'emotion = impact émotionnel.',
        '- faible : peu d’émotion.',
        '- moyen : plusieurs moments touchants.',
        '- eleve : émotion au cœur du récit.',
