# Audit pré-lancement · Planète Stream v0.9.1
...
- Ajout d’un petit marquage de version : **v0.9.1**.
...
- Ajout d’un lien Discord dans la navigation.
- Ajout d’un encart communautaire sur la page d’accueil.
- Ajout d’un rappel Discord dans l’administration.
- Footer enrichi avec un accès communauté.
