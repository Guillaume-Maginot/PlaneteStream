...
async function toggleCommentLike(commentId){
  ...
  if(isLiked){
    ...
    if(ok){
      ...
      // Le compteur affiché est recalculé depuis comment_likes au refresh.
      // Cette mise à jour est conservée seulement comme cache de compatibilité.
    ...
    if(ok){
      ...
      // Le compteur affiché est recalculé depuis comment_likes au refresh.
      // Si la policy UPDATE de comments refuse le cache, le like reste quand même valide.
